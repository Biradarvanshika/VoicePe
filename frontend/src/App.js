...
const supabaseAnonKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxjeHdrZG9pYmNydGJkYXFqanpoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI4Mjg4NzksImV4cCI6MjA2ODQwNDg3OX0.WZ2kDSMbxYfP0Kv4DWhnAZzDNpsVZKJK94lKD43aruY";
...
const NetworkIcon = ({ className }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3 12h18M3 12a9 9 0 019-9m-9 9a9 9 0 009 9"
    />
  </svg>
);
...
const HandshakeIcon = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M17 20l4-4-4-4m-7 8l-4-4 4-4m3 8V4"
    />
    <path d="M3 12h18" />
  </svg>
);
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                ...
                className="text-gray-600 hover:text-[#F57C00] transition duration-300"
              >
                {link.name}
              </a>
            ))}
            <button
              onClick={() => setCurrentPage("postajob")}
              className="bg-[#F57C00] text-white font-semibold px-5 py-2 rounded-lg hover:bg-[#D84315] transition duration-300 shadow-md"
            >
              Post a Job
            </button>
          </nav>
            ...
            <nav className="flex flex-col space-y-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-gray-600 hover:text-[#F57C00] transition duration-300 py-2 text-center"
                >
                  {link.name}
                </a>
              ))}
  ...
  const features = [
    {
      ...
      description:
        "Connect with a pool of workers who are actively seeking jobs right now.",
    },
    {
      icon: <HandshakeIcon className="w-12 h-12 text-[#D84315]" />,
      title: "Bypass Middlemen",
      description:
        "Hire directly and pay fair wages without any commissions or hidden fees.",
    },
    {
      icon: <PhoneIcon className="w-12 h-12 text-[#D84315]" />,
      title: "Access a Verified Workforce",
      description:
        "Our voice-based system helps build a network of trust and reliability.",
    },
  ];
      ...
      <section className="py-20 sm:py-32">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Instantly connect with verified local workers through a simple phone
            call. No middlemen, no apps, no fees.
          </p>
          <button
            onClick={() => setCurrentPage("postajob")}
            className="mt-10 bg-[#F57C00] text-white font-bold px-8 py-4 rounded-lg text-lg hover:bg-[#D84315] transition duration-300 shadow-xl transform hover:scale-105"
          >
            Post a Job for Free
          </button>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2">
              We're fixing the core problems of hiring blue-collar workers.
            </p>
          </div>
  ...
  const steps = [
    {
      ...
      description:
        "Any worker, with any phone, can call our system. No app or internet required.",
    },
    {
      icon: <MicIcon className="w-16 h-16 text-[#F57C00]" />,
      title: "2. AI Registers Their Skill & Location",
      description:
        "Our voice AI asks simple questions in their local language to build a profile.",
    },
    {
      icon: <NetworkIcon className="w-16 h-16 text-[#F57C00]" />,
      title: "3. You Post a Job",
      description:
        "You tell us who you need via our simple web form or even an SMS.",
    },
    {
      icon: <HandshakeIcon className="w-16 h-16 text-[#F57C00]" />,
      title: "4. We Connect You Directly",
      description:
        "Our system instantly matches and notifies relevant workers. You receive details of interested candidates and hire directly.",
    },
  ];
    ...
    <div className="bg-[#FAFAFA] py-20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-[#6D4C41]">
            Simple, Transparent, and Fast.
          </h1>
          <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
            Our process is designed for the real world, connecting employers and
            workers without digital barriers.
          </p>
        </div>
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10">
            {steps.map((step, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 flex items-start space-x-6"
              >
        ...
        <div className="container mx-auto px-6 text-center max-w-2xl">
          <div className="bg-white p-12 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600 mt-4 text-lg">
              Your job has been posted. We are now notifying workers in your
              area.
            </p>
            <button
              onClick={() => {
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Fill this 60-second form. We'll handle the rest.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-[#F57C00] focus:border-[#F57C00]"
                >
              ...
              <div>
                <button
                  ...
                  className="w-full bg-[#F57C00] text-white font-bold py-4 rounded-lg text-lg hover:bg-[#D84315] transition duration-300 shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
    ...
    <div className="container mx-auto px-6 max-w-4xl">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 mt-4">
          To build a more equitable job market for the hands that build our
          nation.
        </p>
      </div>
      <div className="mt-12 text-lg text-gray-700 space-y-6 leading-relaxed">
        <p>
          For **500 million daily wage workers** in India, finding the next job
          is a daily, uncertain struggle. They are the backbone of our economy,
          yet they are often invisible to the digital world. Traditional job
          platforms require literacy, smartphones, and resumes—luxuries they
          cannot afford.
        </p>
        <p>
          This digital divide forces them into the hands of middlemen who often
          take a significant cut of their hard-earned wages, perpetuating a
          cycle of exploitation and instability.
        </p>
        <div className="bg-[#FAFAFA] border-l-4 border-[#F57C00] p-8 rounded-r-lg my-10">
          <p className="text-2xl font-semibold text-[#6D4C41] italic">
            "Vahan is LinkedIn for gig workers. VoicePe is the ambulance for
            invisible laborers."
          </p>
        </div>
        <p>
          **VoicePe was born from a simple idea:** What if finding a job was as
          easy as making a phone call?
        </p>
        <p>
          We are leveraging the most accessible technology available—the human
          voice—to create a platform that is inclusive, fair, and empowering. By
          removing barriers like literacy and internet access, we are giving
          workers their power back, allowing them to connect directly with
          employers and build a future with dignity.
        </p>
      </div>
    </div>
  </div>
